...
Usage:
    python src/collect_medgraphrag_answers.py
    python src/collect_medgraphrag_answers.py --out my_answers.json
"""
...
# Only needed when running from MedQwen — skipped when running from inside MedGraphRAG
_this_dir = str(Path(__file__).resolve().parent)
if _this_dir not in sys.path:
    sys.path.insert(0, _this_dir)

DEFAULT_TEST_PATH = str(Path(__file__).resolve().parent.parent / "data" / "medgraphrag_qa_clean" / "test.jsonl")
