"""
compare_eval.py — Compare MedQwen (fine-tuned) vs MedGraphRAG on 500 stratified test questions.
...
Usage:
    # MedQwen only
    python src/compare_eval.py --skip-medgraphrag

    # Full comparison (MedGraphRAG pipeline must be running)
    python src/compare_eval.py

    # Full comparison with pre-saved MedGraphRAG answers
    python src/compare_eval.py --medgraphrag-answers medgraphrag_answers.json
"""
